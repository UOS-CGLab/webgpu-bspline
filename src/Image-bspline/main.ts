...
async function render() {
	...
	const triangleFunc = drawTiralges(device, presentationFormat, sum, triangleColors);
...
function drawTiralges(device: GPUDevice, presentationFormat: GPUTextureFormat, triangles: Float32Array, triangleColors: number[][]) {
